...
if [ "$1" = "fpdata_migrate" ]; then
    ...
    #add by litongxi for step 1 backup app data
    #OppoNote
    mkdir -p /data/oppo/common/otasave/Note/files
    mkdir -p /data/oppo/common/otasave/Note/shared_prefs
    mkdir -p /data/oppo/common/otasave/Note/databases
    mkdir -p /data/oppo/common/otasave/Note/databases_cloud_backup
    cp -rf /data/data/com.nearme.note/files/* /data/oppo/common/otasave/Note/files
    cp -rf /data/data/com.nearme.note/shared_prefs/* /data/oppo/common/otasave/Note/shared_prefs
    cp -rf /data/data/com.nearme.note/databases/* /data/oppo/common/otasave/Note/databases
    cp -rf /data/data/com.nearme.note/databases_cloud_backup/* /data/oppo/common/otasave/Note/databases_cloud_backup
    ...
    #OppoNote
    rm -rf /data/app/OppoNote
    rm -rf /data/app/com.nearme.note-*
    rm -rf /data/data/com.nearme.note
    rm -rf /data/user_de/0/com.nearme.note
    #endif COLOROS_EDIT
